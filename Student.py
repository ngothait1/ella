...
class Student(Person):
    ...
    def getStudentString(self, index):
        return self.getPersonString(index) + ", Student, The field of study is " + str(self._field_of_study) + ", the year of study is " + str(self._year_of_study) + ", the avg is " + str(self._score_avg)
